...
function renderRepos() {
  ...
  if (!dirty.length) { list.innerHTML = `<div class="empty-run">No uncommitted catalog changes. ${snapshot.repositories.length} repository branch(es) have commits ahead; only those needed by the selected release will be pushed after confirmation.</div>`; return; }
